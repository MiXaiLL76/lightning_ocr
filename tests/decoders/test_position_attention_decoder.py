...
import torch
from lightning_ocr.modules.decoders.position_attention_decoder import PositionAttentionDecoder
...
class TestPositionAttentionDecoder(TestCase):
    ...
    def test_init(self):
        decoder = PositionAttentionDecoder(num_classes=self.num_classes, return_feature=False)
